        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
			<div class="box">
				<div class="box-header with-border">
					<h3 class="box-title">Search By Student Registration No</h3>
				</div>
				<div class="box-body">
				    <form role="form" action="<?php echo site_url('Fees/searchStudentFees');?>" method="post">
					<div class="input-group margin">
					<input type="text" class="form-control" id="regno" placeholder="Enter Student Registration No" name="regno" autocomplete="off" required />
						<span class="input-group-btn">
						  <button type="submit" class="btn btn-primary"  id="searchstudentbyregno">Search</button>
						</span>
					</div>
					</form>
				</div>
            ...
            <form role="form" action="<?php echo site_url('Fees/searchStudentClassSectionFeesCard');?>" method="post">
              <div class="box-body">
